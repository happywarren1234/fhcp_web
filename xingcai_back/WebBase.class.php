...
class WebBase extends Object{
	...
	public function BJpk10(&$actionNo, &$actionTime, $time=null){
		$this->setTimeNo($actionTime, $time);
		$actionNo = 179*(strtotime(date('Y-m-d', $time))-strtotime('2017-04-11'))/3600/24+$actionNo+611788;
	}
	//北京快乐8
	public function bjkl8(&$actionNo, &$actionTime, $time=null){
		$this->setTimeNo($actionTime, $time);
		$actionNo = 179*(strtotime(date('Y-m-d', $time))-strtotime('2017-04-11'))/3600/24+$actionNo+817217;
	}
	//澳门快乐8
