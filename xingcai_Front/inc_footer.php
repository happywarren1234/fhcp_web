...
<script type="text/javascript" src="/js/nsc/dialogUI/jquery.dialogUI.js"></script>
	...
	<div class="sidebar_con">
		...
		<div class="sidebar_othergames">
			<div class="sidebar_header_title"><a href="/" target="_blank">帝彩彩票</a></div>
		</div>
			...
			<div class="air_box_t">
				<div class="airflash" id="air_top">
    				...
    				<script type="text/javascript">
			            ...
			            so.addVariable("appurl", "#"); // 在这里修改帝彩AIR客户端下载地址，air名称Main可以随意修改
...
<div class="login_footer">
	<div class="warp980">
		...
		<div class="clearfix">
			...
			<p class="t-right">
				未满18周岁禁止购买<br />
				Copyright © SinCai 2010-2017  帝彩国际 版权所有
			</p>
		</div>
	</div>
</div>
