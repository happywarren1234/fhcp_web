...
<div class="lottery_head" id="kaijiang" type="<?=$this->type?>" ctype="<?=$types[$this->type]['type']?>">
 ...
 <?php if($types[$this->type]['type']==3) { //3D?>
     <div class="lottery_num left">
				...
				<div class="louhao">
					<a class="wanfa" href="/zst/3d.php?typeid=<?= $this->type ?>"  target="_blank"></a>
				</div>
			</div>
			</div>
	</div>
	...
	<div class="tools left">
	   ...
	   <?php }else if($types[$this->type]['type']==9) { //快3?>
				...
				<div class="louhao">
					<a class="wanfa" href="/zst/k3.php?typeid=<?= $this->type ?>"  target="_blank"></a>
				</div>
			</div>
...
<?php }else if($types[$this->type]['type']==11) { //六合彩?>
				...
				<div class="louhao">
					<a class="wanfa"  href="javascript:void(0)" onClick="future()" ></a>
				</div>
			</div>
...
<?php }else if($types[$this->type]['type']==4) { //快乐十分?>
				...
				<div class="louhao">
					<a class="wanfa" href="/zst/klsf.php?typeid=<?= $this->type ?>"  target="_blank"></a>
				</div>
			</div>
	...
	<div class="tools left">
      ...
      <?php }else if($types[$this->type]['type']==2) { //11选5?>
				...
				<div class="louhao">
					<a class="wanfa" href="/zst/11x5.php?typeid=<?= $this->type ?>"  target="_blank"></a>
				</div>
			</div>
...
<?php }else{  ?>
	<div class="lottery_num left">
				...
				<div class="louhao">
					<a class="wanfa" href="/zst?typeid=<?= $this->type ?>"  target="_blank"></a>
				</div>
		</div>	
			</div>
	</div>
